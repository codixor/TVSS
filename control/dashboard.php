...
<div class="row-fluid">
    <div class="span12">
        ...
        <div class="row-fluid" style="margin-top: 0px">
            ...
            <div class="span2">
                <img alt="" src="img/gCons/processing-02.png">&nbsp; Pending episode links: <a href="index.php?menu=tv_links"><strong><?php print(count($show->getLinksCount())); ?></strong></a>
            </div>
        ...
        <div class="row-fluid">
            ...
            <div class="span2">
                <img alt="" src="img/gCons/processing-02.png">&nbsp; Pending movie links: <a href="index.php?menu=movie_links"><strong><?php print(count($movie->getLinksCount())); ?></strong></a>
            </div>
