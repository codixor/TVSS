					...
					<?php 
						...
						if (isset($_POST['process'])){
							...
							if ($step == 1){
								...
								if (!isset($_POST['admin_folder']) || !$_POST['admin_folder']){
									$step3_errors[1] = "Please enter a name for your Admin Folder";
								}
								
								
								if (!count($step3_errors)){
									$_SESSION['admin_folder'] = $_POST['admin_folder'];
						...
						if ($step == 4){
							if (!isset($_SESSION['mysql_host']) || !isset($_SESSION['mysql_user']) || !isset($_SESSION['mysql_pass']) || !isset($_SESSION['mysql_name'])){
								...
								$step = 2;
							} elseif  (!isset($_SESSION['admin_folder'])){
								$step = 3;
							}
						}
